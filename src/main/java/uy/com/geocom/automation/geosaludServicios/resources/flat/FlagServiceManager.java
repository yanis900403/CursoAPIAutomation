...
public class FlagServiceManager implements FlagManager
{

private String ResourceType="Flag";


List<Array> listCodingItem=new ArrayList<>();


    @Override
    public void completeParametersJsonResourceFlag() {
     ...
     //    identifier.add("Yanisl222");
        ...
        // RestAssured.given().log().all().body(jsonParametersFlag).get();

    }

    @Override
    public void completeJsonResourceFlag(FlagParameters jsonParameters) {
